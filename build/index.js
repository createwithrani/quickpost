...
function QuickPostKebabMenu(_ref) {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (0 !== postId) {
      location.href = (0,_wordpress_url__WEBPACK_IMPORTED_MODULE_7__.addQueryArgs)("post.php", {
        post: postId,
        action: "edit"
      });
    }
  ...
  (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Duplicate %s", "createwithrani-quick-post-button"), singleLabel), duplicationStatus && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.Spinner, null))));
}
...
function QuickPostButton() {
  ...
  const {
    addNewLabel,
    singleLabel
  } = (0,_utils__WEBPACK_IMPORTED_MODULE_7__.getPostLabels)(postType);
  const restBase = (0,_utils__WEBPACK_IMPORTED_MODULE_7__.getPostTypeRestBase)(postType); // Until we get the label info back, we don't want to render the button.
