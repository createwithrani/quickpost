/******/ (function () {
  ...
  \**********************/
		...
		/* harmony import */ var _wordpress_core_data__WEBPACK_IMPORTED_MODULE_3__ =
			__webpack_require__(
				/*! @wordpress/core-data */ "@wordpress/core-data"
			);
		/* harmony import */ var _wordpress_core_data__WEBPACK_IMPORTED_MODULE_3___default =
			/*#__PURE__*/ __webpack_require__.n(
				_wordpress_core_data__WEBPACK_IMPORTED_MODULE_3__
			);
		...
		/* harmony import */ var _wordpress_url__WEBPACK_IMPORTED_MODULE_5__ =
			__webpack_require__(/*! @wordpress/url */ "@wordpress/url");
		/* harmony import */ var _wordpress_url__WEBPACK_IMPORTED_MODULE_5___default =
			/*#__PURE__*/ __webpack_require__.n(
				_wordpress_url__WEBPACK_IMPORTED_MODULE_5__
			);
		/* harmony import */ var _wordpress_dom_ready__WEBPACK_IMPORTED_MODULE_6__ =
			__webpack_require__(
				/*! @wordpress/dom-ready */ "@wordpress/dom-ready"
			);
		/* harmony import */ var _wordpress_dom_ready__WEBPACK_IMPORTED_MODULE_6___default =
			/*#__PURE__*/ __webpack_require__.n(
				_wordpress_dom_ready__WEBPACK_IMPORTED_MODULE_6__
			);
		...
		function AddNewPostButton() {
			...
			const { singleLabel, addNewLabel } = (0,
			_wordpress_data__WEBPACK_IMPORTED_MODULE_2__.useSelect)(
				(select) => {
					const { getPostTypes } = select(
						_wordpress_core_data__WEBPACK_IMPORTED_MODULE_3__.store
					);
					...
					if (undefined !== filteredPostTypes) {
						return {
							...
							singleLabel:
								filteredPostTypes[0].labels.singular_name,
						};
					}
			...
			if (undefined !== addNewLabel) {
				...
				_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(
					_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.Button,
					{
						...
						onClick: () =>
							(location.href = (0,
							_wordpress_url__WEBPACK_IMPORTED_MODULE_5__.addQueryArgs)(
								"post-new.php",
								{
									post_type: postType,
								}
     ...
     %2$s: Name of current post type. */
		...
		(0, _wordpress_data__WEBPACK_IMPORTED_MODULE_2__.subscribe)(() => {
			...
			_wordpress_dom_ready__WEBPACK_IMPORTED_MODULE_6___default()(() => {
				...
				(0, _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.render)(
					(0,
					_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(
						AddNewPostButton,
						null
